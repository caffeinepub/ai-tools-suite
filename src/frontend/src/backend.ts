...
export class Backend implements backendInterface {
    ...
    async clearToolHistory(arg0: ToolType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearToolHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllRecentHistory(): Promise<Array<HistoryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRecentHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentToolHistory(arg0: ToolType): Promise<Array<HistoryEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecentToolHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUsageStats(): Promise<Array<[ToolType, bigint]>> {
        if (this.processError) {
            try {
    ...
    async saveHistory(arg0: ToolType, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveHistory(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
